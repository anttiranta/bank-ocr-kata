...
- Scan file with a number of entries which each look like this:
    _  _     _  _  _  _  _ 
  | _| _||_||_ |_   ||_||_|
  ||_  _|  | _||_|  ||_| _|
...
- A valid account number has a valid checksum. Validity of account numbers must be ensured. Checksum can be calculated as follows:
...
- Write out a file of account numbers, one for each input file, in this format:
